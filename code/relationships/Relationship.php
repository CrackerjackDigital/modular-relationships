...
abstract class Relationship extends Field {
	...
	public static function relationship_name($fieldName = '') {
		return static::Name . ($fieldName ? ".$fieldName" : '');
	}
	...
	protected function gridField($Name = null, $configClassName = null) {
		if ($this()->isInDB()) {
			// Name and configClassName if empty will be updated according to what GridFieldConfig determins
	 ...
	 *
	 * @param string $Name if not supplied then static.Name via relationship_name() and is updated
